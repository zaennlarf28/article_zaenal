          ...
          <div class="row g-5">
            ...
            @if ($loop->index === 3)
              <div class="post-entry lg">
                ...
                <h2><a href="blog-details.html">{{ \Illuminate\Support\Str::limit($data->judul, 30) }}</a></h2>
                <p class="mb-4 d-block">{{ \Illuminate\Support\Str::limit($data->deskripsi, 200) }}</p>

                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/person-1.jpg" alt="" class="img-fluid"></div>
                  <div class="name">
                    <h3 class="m-0 p-0">{{ $data->penulis }}</h3>
                  </div>
                </div>
              </div>
              @endif
                    ...
                    <div class="col-12 mb-4">
                        <div class="d-flex flex-column flex-md-row gap-3 align-items-start border-bottom pb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0">{{ \Illuminate\Support\Str::limit($data->deskripsi, 20) }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            @foreach ($berita as $index => $data)
                <li>
                    <a href="{{ route('berita.show', $data->id) }}">
                        ...
                        <h3>{{ \Illuminate\Support\Str::limit($data->deskripsi, 50) }}</h3>
