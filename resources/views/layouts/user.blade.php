...
$(document).ready(function() {
    $('#formKonsultasi').on('submit', function(e) {
        ...
        const pertanyaan = $('textarea[name="pertanyaan"]').val();

        // Bisa juga kirim ke server via AJAX kalau perlu disimpan
        // $.post('/simpan-pertanyaan', $(this).serialize());

        // Tambahkan pertanyaan ke daftar
        $('#daftarPertanyaan').append(`
            <div class="alert alert-info mt-2">
                <strong>Pertanyaan Anda:</strong><br>${pertanyaan}
            </div>
        `);
