                    ...
                    <div class="panel-body">
                        <form action="{{ route('konsultasi.update', $konsultasi->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" name="deskripsi" value="{{ $konsultasi->deskripsi }}"></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Penulis</label>
                                <input type="text" class="form-control" name="penulis" value="{{ $konsultasi->penulis }}">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Ganti Gambar</label><br>
                                <img src="{{ asset('storage/konsultasi/' . $konsultasi->gambar) }}" alt="" style="width: 120px; height: 120px; object-fit: cover;" class="mb-2">
