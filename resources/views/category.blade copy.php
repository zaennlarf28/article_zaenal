    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ url('/single_post') }}">Single Post</a></li>
          <li class="dropdown"><a href="#"><span>Categories</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="{{ url('/category') }}" class="active">Category 1</a></li>
              ...
              <li><a href="{{ url('/category') }}" class="active">Category 2</a></li>
              <li><a href="{{ url('/category') }}" class="active">Category 3</a></li>
              <li><a href="{{ url('/category') }}" class="active">Category 4</a></li>
            </ul>
          </li>
