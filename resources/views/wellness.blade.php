    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="row gy-4">
          ...
          <div class="col-md-6">
            <a href="{{ route('diet.detail', $data->id) }}">
              @if ($data->gambar)
            ...
            <div class="mt-2">
              <h5 class="mb-1"><a href="{{ route('diet.detail', $data->id) }}">{{ Str::limit($data->judul, 70) }}</a></h5>
              <p class="mb-0 text-muted" style="font-size: 14px;">
                <a href="{{ route('diet.detail', $data->id) }}">{{ Str::limit($data->deskripsi, 100) }}</a>
              </p>
            </div>
          </div>
          @endforeach
